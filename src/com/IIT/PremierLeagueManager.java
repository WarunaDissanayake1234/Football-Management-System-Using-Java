...
public class PremierLeagueManager implements LeagueManager {
    ...
    public void displayMenu(){
        while (true){
            ...
            System.out.println("Display Calender and Match (press 6)");
            System.out.println("-----------------------------------------------");
    ...
    private void addTeam() {
        ...
        if (league.contains(club)){
            System.out.println("This club is already in the club");
            return;
        }
    ...
    private void displayStatistics(){
        ...
        for (FootballClub club : league){
            if (club.getName().equals(line)){
                ...
                System.out.println("Club " + club.getName() +" matches scored Goals " + club.getScoredGoalsCount());
                System.out.println("Club " + club.getName() +" matches received Goals " + club.getReceivedGoalsCount());
                System.out.println("Club " + club.getName() +" matches Points " + club.getPoints());
        ...
        System.out.println("Enter Away team goals:");
                ...
                int awayGoals = -1;
                   ...
                   if (homeGoals > awayGoals){
                       ...
                       away.setDrawCount(home.getDrawCount()+1);
                   }
    }
